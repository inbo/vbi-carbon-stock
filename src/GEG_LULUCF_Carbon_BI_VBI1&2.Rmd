...
carbon_periodes %>%
  ...
  labs(x = "Carbon (ton/ha) periode 1",
       y = "Carbon (ton/ha) periode 2")
```

N.B. de "repeated & unpaired" categorie omvat proefvlakken die in de tweede periode niet exact geherlokaliseerd konden worden.
Deze categorie bevat ook de bosrand proefvlakken die in de eerste periode systematisch verschoven om volledig binnen bos te liggen, maar in de tweede periode niet verschoven werden (om geen vertekening te veroorzaken).
